...
static bool8 HasAssociatedItem(u8 moveIndex) {
    ...
    sw = moveIndex + 1;
    switch(sw) {
        case 0: return TRUE; // default
        case 1: return FALSE; // cut
        case 2: return TRUE; // flash
        case 3: return FALSE; // rock smash
        case 4: return FALSE; // strength
        case 5: return TRUE; // fly
        case 6: return TRUE; // dive
        case 7: return FALSE; // waterfall
        case 8: return TRUE; // teleport
        case 9: return TRUE; // dig
        case 10: return TRUE; // secret power
        case 11: return TRUE; // teleport
        case 12: return TRUE; // softboiled
        case 13: return TRUE; // sweet scent
        case 14: return TRUE; // milk drink
    }
}
...
static void SetPartyMonFieldSelectionActions(struct Pokemon *mons, u8 slotId) {
    ...
    for (j = 0; sFieldMoves[j] != FIELD_MOVES_COUNT; j++) {
        ...
        if ((PokemonKnowsMove(&mons[slotId], sFieldMoves[j]) || CanMonLearnMove(&mons[slotId], sFieldMoves[j])) && HasAssociatedItem(j)) {
