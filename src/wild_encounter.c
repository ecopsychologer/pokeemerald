...
static void CreateWildMon(u16 species, u8 level)
{
        ...
        && Random() % 3 != 0)
    {
        ...
        CreateMonWithGenderNatureLetter(&gEnemyParty[0], species, GenerateCurvedRandomLevel(0,0), USE_RANDOM_IVS, gender, PickWildMonNature(), 0);
        return;
    }

    CreateMonWithNature(&gEnemyParty[0], species, GenerateCurvedRandomLevel(0,0), USE_RANDOM_IVS, PickWildMonNature());
}
#ifdef BUGFIX
